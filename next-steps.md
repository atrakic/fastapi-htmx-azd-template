...
- [app/fastapi-htmx-azd-template.bicep](./infra/app/fastapi-htmx-azd-template.bicep) - Azure Container Apps resources to host the 'fastapi-htmx-azd-template' service.
